...
export default function Desk(props) {
  ...
  useEffect(() => {
    ...
    allTextures.forEach((texture) => {
        if (texture) {
          texture.image.playsInline = true; // Fixed casing (playsInline, not playsInLine)
  ...
  return (
    <Selection>
      <group {...props} dispose={null}>
        ...
        <group position={[-0.532, 1.025, -0.016]} rotation={[0, 0.431, 0]}>
          ...
          <Select enabled={hovered === 'leftScreen'}>
            <group
            onPointerOver={() => {setHover('leftScreen'); document.body.style.cursor = 'pointer'}}
        ...
        <group position={[0.532, 1.025, -0.016]} rotation={[0, -0.849, -Math.PI / 2]}>
          <Select enabled={hovered === 'rightScreen'}>
            <group 
            onPointerOver={() => {setHover('rightScreen'); document.body.style.cursor = 'pointer'}}
            onPointerOut={() => {setHover(null); document.body.style.cursor = 'auto'}} >
        ...
        <group position={[0, 1, -0.128]}>
          <Select enabled={hovered === 'centerScreen'}>
            <group
            onPointerOver={() => {setHover('centerScreen'); document.body.style.cursor = 'pointer'}}
            onPointerOut={() => {setHover(null); document.body.style.cursor = 'auto'}} >
        ...
        <Select enabled ={hovered === 'book'}>
          <group 
          onPointerOver={(e) => {e.stopPropagation(); setHover('book'); document.body.style.cursor = 'pointer'}}
        ...
        <Select enabled ={hovered === 'speaker'}>
          <group 
          onPointerOver={(e) => {e.stopPropagation(); setHover('speaker'); document.body.style.cursor = 'pointer'}}
          onPointerOut={(e) => {e.stopPropagation(); setHover(null); document.body.style.cursor = 'auto'}}
          >
      ...
      <EffectComposer multisampling={8} autoClear={false}>
        <Outline 
          blur // Makes it glowy
          edgeStrength={10} // How strong the white line is
          width={1000} // Width of the outline
